...
Settings _$SettingsFromJson(Map<String, dynamic> json) => Settings(
  ...
  maxRows: (json['maxRows'] as num?)?.toInt() ?? 7,
...
Site _$SiteFromJson(Map<String, dynamic> json) => Site(
  ...
  json['dir'] as String?,
  (json['minSpeed'] as num).toInt(),
  (json['maxSpeed'] as num).toInt(),
  (json['minPGSpeed'] as num).toInt(),
  (json['maxPGSpeed'] as num).toInt(),
